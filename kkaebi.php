...
<!--// Scroll Motion Script -->
            ...
            <span class="name_box">
            	<span class="kor" data-aos="fade-up" data-aos-duration="1400">잠시만 기다려 주세요...</span>
                <span class="eng" data-aos="fade-up" data-aos-duration="1500">차량조회V1.0</span>
            </span>
        </li>
    </ul>
    <ul class="copyright">
    	        
        <li class="cp2">ⓒ kkaebi. ALL RIGHTS RESERVED.</li>
    </ul>
</div>
